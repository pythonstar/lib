...
{
	SkinH_Adjust_HSV( ((CSliderCtrl*)GetDlgItem(IDC_SLIDER1))->GetPos(),
...
{
	// TODO: Add your control notification handler code here
	SkinH_Alpha_Menu(((CSliderCtrl*)GetDlgItem(IDC_SLIDER11))->GetPos());
	*pResult = 0;
}
